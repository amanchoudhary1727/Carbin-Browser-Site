  ...
  return (
    <div className="min-h-screen bg-shark pt-24 pb-12">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16">
          <img
            src={feature.customImage ? getAssetPath(feature.customImage) : getAssetPath('background.png')}
            alt="Feature Preview"
            className="max-w-5xl mx-auto w-full h-auto object-cover rounded-lg shadow-retro border-2 border-slateGray"
          />
        </div>
