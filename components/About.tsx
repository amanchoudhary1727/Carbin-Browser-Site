...
import { Terminal, User, Github, Mail } from 'lucide-react';
          ...
          <div className="flex flex-col md:flex-row justify-between items-center border-t-2 border-dashed border-slateGray pt-6 gap-6">
            <div className="flex gap-4">
              <a
                ...
                className="p-2 border-2 border-slateGray hover:border-retroYellow hover:bg-white/5 text-slateGray hover:text-retroYellow transition-all group/icon"
                title="GitHub"
                target="_blank"
                rel="noreferrer"
              >
